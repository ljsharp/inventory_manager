...
const deleteData = () => {
    ...
    form.delete(route('admin.role.destroy', data.role?.id), {
        preserveScroll: true,
        onSuccess: () => {
            form.reset();
        },
...
const onPageChange = (event) => {
    router.get(route('admin.role.index'), { page: event.page + 1 }, { preserveState: true });
};
            ...
            >
                ...
                <Column header="Permission">
                    <template #body="slotProps">
                        ...
                        <div v-else>{{ slotProps.data.permissions.length }} Permission</div>
                    </template>
                </Column>
