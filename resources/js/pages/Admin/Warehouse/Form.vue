    ...
    <form @submit.prevent="submit">
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col items-start gap-1">
                ...
                <Message size="small" v-if="warehouseForm.errors.contact_info" severity="error">{{ warehouseForm.errors.contact_info }}</Message>
            </div>

            <div class="flex flex-col items-start gap-1">
                <label>Capacity</label>
                <InputText type="number" v-model="warehouseForm.capacity" class="w-full" />
                <Message size="small" v-if="warehouseForm.errors.capacity" severity="error">{{ warehouseForm.errors.capacity }}</Message>
            </div>
