...
class StockTransferRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'transfers.*.source_warehouse_id' => ['required', 'exists:warehouses,id'],
            'transfers.*.destination_warehouse_id' => ['required', 'exists:warehouses,id', 'different:transfers.*.source_warehouse_id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'transfers.*.source_warehouse_id.required' => 'The source warehouse is required for each transfer.',
            'transfers.*.source_warehouse_id.exists' => 'The selected source warehouse does not exist.',
            'transfers.*.destination_warehouse_id.required' => 'The destination warehouse is required for each transfer.',
            'transfers.*.destination_warehouse_id.exists' => 'The selected destination warehouse does not exist.',
            'transfers.*.destination_warehouse_id.different' => 'The source and destination warehouses must be different for each transfer.',
